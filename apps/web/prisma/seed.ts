...
async function main() {
  ...
  const productsData = [
    ...
    },
    {
      ...
      variants: [
        { size: 'S', color: 'Vintage Black/Apricot', stock: 20, sku: 'VGT-VB-S' },
        { size: 'M', color: 'Vintage Black/Apricot', stock: 30, sku: 'VGT-VB-M' },
        { size: 'L', color: 'Vintage Black/Apricot', stock: 25, sku: 'VGT-VB-L' },
        { size: 'XL', color: 'Vintage Black/Apricot', stock: 20, sku: 'VGT-VB-XL' },
      ],
    },
    {
      ...
      images: [
        {
          ...
          alt: 'Classic Leather Sneakers Black/White/Red - Side View',
          isPrimary: true,
          order: 1,
        },
        {
          ...
          alt: 'Classic Leather Sneakers Black/White/Red - Front View',
          isPrimary: false,
          order: 2,
        },
        {
          ...
          alt: 'Classic Leather Sneakers Black/White/Red - Detail',
          isPrimary: false,
          order: 3,
        },
      ],
      variants: [
        { size: 'US 7', color: 'Black/White/Red', stock: 15, sku: 'SOG-BWR-07' },
        { size: 'US 8', color: 'Black/White/Red', stock: 25, sku: 'SOG-BWR-08' },
        { size: 'US 9', color: 'Black/White/Red', stock: 30, sku: 'SOG-BWR-09' },
        { size: 'US 10', color: 'Black/White/Red', stock: 35, sku: 'SOG-BWR-10' },
        { size: 'US 11', color: 'Black/White/Red', stock: 30, sku: 'SOG-BWR-11' },
        { size: 'US 12', color: 'Black/White/Red', stock: 20, sku: 'SOG-BWR-12' },
      ],
    },
    {
      ...
      images: [
        ...
        {
          url: 'https://static.nike.com/a/images/t_web_pdp_535_v2/f_auto/7b3aad5b-5cc3-4e38-9b50-8f68e0cf2c3b/AIR+FORCE+1+%2707+LV8.png',
          alt: 'Light Smoke Grey - Side View',
          isPrimary: false,
          order: 3,
        },
        {
          url: 'https://static.nike.com/a/images/t_web_pdp_535_v2/f_auto/8ce70b93-2bb3-4e98-8f1d-85e0ba0e5f67/AIR+FORCE+1+%2707+LV8.png',
